...
mse_CV <- data.frame(
  cv_mse_statnu0.5 = cv_mse_statnu0.5,
  cv_mse_statnu1.5 = cv_mse_statnu1.5,
  cv_mse_statnuest = cv_mse_statnuest,
  cv_mse_nonstatnu0.5 = cv_mse_nonstatnu0.5,
  cv_mse_nonstatnu1.5 = cv_mse_nonstatnu1.5,
  cv_mse_nonstatnuest = cv_mse_nonstatnuest
)
...
save(mse_loocv_lm, best_KNN_mse, MSE_ISOCOV, file = here("data_files/new_simple_linear_regression_results.RData"))
```
