...
```{r, eval = FALSE}
cv_mse_statnu0.5 <- MetricGraph::cross_validation(models = MetricGraph_fit_statnu0.5)
cv_mse_statnu1.5 <- MetricGraph::cross_validation(models = MetricGraph_fit_statnu1.5)
cv_mse_statnuest <- MetricGraph::cross_validation(models = MetricGraph_fit_statnuest)
cv_mse_nonstatnu0.5 <- MetricGraph::cross_validation(models = MetricGraph_fit_nonstatnu0.5)
cv_mse_nonstatnu1.5 <- MetricGraph::cross_validation(models = MetricGraph_fit_nonstatnu1.5)
cv_mse_nonstatnuest <- MetricGraph::cross_validation(models = MetricGraph_fit_nonstatnuest)
mse_CV <- data.frame(
  cv_mse_statnu0.5 = cv_mse_statnu0.5$mse[1],
  cv_mse_statnu1.5 = cv_mse_statnu1.5$mse[1],
  cv_mse_statnuest = cv_mse_statnuest$mse[1],
