...
p_err_int <- ggplot(dat, aes(nu, error, colour = as.factor(m))) + 
  ...
  labs(x = "$\\alpha\\mbox{ }(\\mbox{Smoothness parameter})$", y = "$\\mbox{Covariance Error}\\quad(\\log_{10}\\mbox{ scale})$", color = "$m$") #+ ggtitle("$\\mbox{Interval graph}$") 

myggsave(p_err_int, width = 12, height = 6, use_mathpazo = FALSE)
```
...
p_err_cir <- ggplot(dat, aes(nu, error, colour = as.factor(m))) + 
  ...
  theme(panel.spacing = unit(0.3, "cm"), 
        ...
        legend.title = element_text(size = 14),      # Legend title
        legend.text = element_text(size = 12)) +
  labs(x = "$\\alpha\\mbox{ }(\\mbox{Smoothness parameter})$", y = "$\\mbox{Covariance Error}\\quad(\\log_{10}\\mbox{ scale})$", color = "$m$") #+ ggtitle("$\\mbox{Circle graph}$") 

myggsave(p_err_cir, width = 12, height = 6, use_mathpazo = FALSE)
```
...
p_err_tad <- ggplot(dat, aes(nu, error, colour = as.factor(m))) + 
  ...
  theme(panel.spacing = unit(0.3, "cm"), 
        ...
        legend.title = element_text(size = 14),      # Legend title
        legend.text = element_text(size = 12)) +
  labs(x = "$\\alpha\\mbox{ }(\\mbox{Smoothness parameter})$", y = "$\\mbox{Covariance Error}\\quad(\\log_{10}\\mbox{ scale})$", color = "$m$") #+ ggtitle("$\\mbox{Tadpole graph}$") 

myggsave(p_err_tad, width = 12, height = 6, use_mathpazo = FALSE)
```
