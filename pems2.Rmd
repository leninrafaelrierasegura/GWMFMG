...
# Extract the data from the graph
data <- graph$get_data() |> as.data.frame() |> select(y, mean_value, repl)
...
save(mse_loocv_lm, mse_loocv_lmer, file = here("data_files/simple_linear_regression_results.RData"))
```
